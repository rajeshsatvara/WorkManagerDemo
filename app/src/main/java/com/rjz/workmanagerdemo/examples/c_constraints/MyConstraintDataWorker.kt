...
internal class MyConstraintDataWorker(context: Context, params: WorkerParameters) : Worker(context, params) {

    override fun doWork(): Result {
        var desc = inputData.getString(ConstraintsDataRequestActivity.KEY_TASK_DESC) as String

        sendNotification("test task constrints", desc);

        // pass output data
        var outputData = Data.Builder()
            .putString(ConstraintsDataRequestActivity.KEY_TASK_OUTPUT, "---all is done constrints---")
            .build()
